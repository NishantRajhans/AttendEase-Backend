...
import { AddStudent,AddSubject,AddTeacher,GetAllStudents,GetAllTeachers,EditTeacher,GetAllSubjects, GetAllGrades,DeleteStudent ,EditStudent,EditSubject,DeleteTeacher,DeleteSubject} from "../controller/Admin.js";
...
router.get("/GetAllStudent",AuthMiddleware,GetAllStudents);
router.get("/GetAllTeacher",AuthMiddleware,GetAllTeachers);
router.get("/GetAllSubject",AuthMiddleware,GetAllSubjects);
router.get("/GetAllGrade",AuthMiddleware,GetAllGrades);
